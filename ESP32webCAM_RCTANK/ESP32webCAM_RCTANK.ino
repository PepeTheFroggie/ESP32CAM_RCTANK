...
static esp_err_t index_handler(httpd_req_t *req)
{
  ...
  if (httpd_req_get_url_query_len(req) > 0)
  {
    ...
    if      (buf[0] == 'f') motcmd(1); 
    else if (buf[0] == 'l') motcmd(2);
    else if (buf[0] == 's') motcmd(3); 
    else if (buf[0] == 'r') motcmd(4); 
    else if (buf[0] == 'b') motcmd(5);  
  ...
  out += "<tr>";
  out += "<td></td>";
  out += "<td><button onclick=\"window.location.href='?f'\">F</button></td>";
  out += "<td></td>";
  out += "</tr>";
  out += "<tr>";
  out += "<td><button onclick=\"window.location.href='?l'\">L</button></td>";
  out += "<td><button onclick=\"window.location.href='?s'\">S</button></td>";
  out += "<td><button onclick=\"window.location.href='?r'\">R</button></td>";
  out += "</tr>";
  out += "<tr>";
  out += "<td></td>";
  out += "<td><button onclick=\"window.location.href='?b'\">B</button></td>";
  out += "<td></td>";
  out += "</tr>";
  out += "</table>";
